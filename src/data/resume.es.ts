...
export const resumeEs: ResumeData = {
  personalInfo: {
    ...
    title: "",
    tagline: "8+ años en gestión de portafolios, asignación de activos y relación con clientes, apasionado por el desarrollo de soluciones tecnológicas para la industria financiera",
    ...
    summary: `Profesional con más de 8 años de experiencia en gestión de portafolios y asignación de activos. Trayectoria comprobada supervisando portafolios multiactivos para clientes UHNW, con sólida experiencia en estrategia de inversión, selección de fondos y análisis de desempeño. Altamente disciplinado, con foco en el cliente y sólido conocimiento en la implementación de soluciones centralizadas con inteligencia artificial para la industria financiera. Bilingüe en inglés y español. Residencia estadounidense en trámite.`,
  },
