...
export const resumeEs: ResumeData = {
  personalInfo: {
    ...
    title: "Profesional Senior de Inversiones",
    tagline: "8+ años en gestión de portafolios y asignación de activos, creando herramientas data-driven para wealth management",
  ...
  projects: [
    ...
    },
    {
      ...
      highlights: ["Agente autónomo: conversa, consulta datos y ejecuta acciones por voz", "Herramientas conectadas (email, calendario, market data) con memoria y contexto persistente", "Las lecturas se ejecutan solas; los envíos o ediciones requieren confirmación hablada", "Finanzas: consultas de portafolio y mercado, briefings y apoyo a propuestas/reportería", "Inmobiliario: pipeline de deals, cifras de underwriting y seguimiento a inversionistas", "Núcleo agnóstico a la vertical — el mismo agente se integra a una nueva industria"],
      hasDemo: false,
      videoId: "",
    },
    {
      title: "Plataforma de Inteligencia de Deals Inmobiliarios",
    ...
    {
      title: "Índice de Renta Fija Chilena",
      description: "Índices replicables de renta fija para el mercado de bonos chileno — soberanos (BTP, BTU) y corporativos (AAA a BBB) — construidos íntegramente con datos públicos del Banco Central, la CMF y la Bolsa de Santiago.",
      tech: ["Renta Fija", "Índices de Bonos", "Curvas de Tasas", "Banco Central", "CMF", "Métricas de Riesgo"],
      categories: ["finance"],
      highlights: ["12 índices que cubren bonos soberanos y corporativos por rating", "Metodología de precios transparente con datos públicos", "Más de 10 años de datos diarios del Banco Central y la CMF", "Construcción de curvas de tasas y análisis de duración", "Seguimiento de drawdown y métricas de riesgo por rating crediticio", "Herramienta de benchmark para portafolios de renta fija chilena"],
      hasDemo: true,
  ...
  awards: [
    {
      ...
      scale: "1 de 12 proyectos ganadores · 150+ postulantes",
      detail: "Seleccionado como uno de los 12 proyectos ganadores entre más de 150 postulantes en el concurso GenIA (IA Generativa) de BCI, destacando por su impacto e innovación. 3er lugar en la categoría Análisis de Datos por la International Investment Platform, que integra los datos de custodia de Pershing (el custodio de Bank of New York).",
    },
  ],
