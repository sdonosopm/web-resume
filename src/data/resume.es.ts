...
export const resumeEs: ResumeData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Agente autónomo por voz que corre localmente en macOS: le hablas y responde con voz neuronal, razonando con un cerebro basado en Claude con herramientas conectadas, memoria persistente y confirmación hablada antes de cualquier acción que envíe, escriba, agende o gaste. Lee correo, calendario, archivos y market data en vivo, hace research web multi-fuente con citas, y entrega un briefing matinal proactivo — un solo agente que se integra a cualquier flujo de trabajo.",
      tech: ["Agente Autónomo", "IA por Voz", "Claude / LLM", "Orquestación de Agentes", "Speech-to-Text & TTS", "Uso de Herramientas (MCP)"],
      categories: ["web-app"],
      highlights: ["Voz manos libres: speech-to-text on-device + TTS neuronal local", "Cerebro basado en Claude con herramientas conectadas (MCPs) y memoria persistente", "Lee correo, calendario, archivos y market data en vivo (ETFs globales)", "Research web multi-fuente con fuentes citadas", "Briefing matinal proactivo: mercado, agenda y foco del día", "Confirmación hablada antes de enviar, escribir, agendar o gastar"],
      hasDemo: false,
      videoId: "",
    },
    {
